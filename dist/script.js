...
var accordion = function accordion(trigger, item) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var burger = function burger(menu, _burger) {
  var menuElem = document.querySelector(menu);
  var burgerElem = document.querySelector(_burger);
...
var drop = function drop() {
  ...
  function hightlight(item) {
    item.closest('.file_upload').style.border = "1px solid black";
  }
...
var scroll = function scroll(upSellector) {
  var upElem = document.querySelector(upSellector);
  window.addEventListener('scroll', function () {
